...
const Controls = () => {
    const { zoomLevel, setZoomLevel, isPlaying, setIsPlaying, isRecording, setIsRecording, tempo, setTempo, timeSignature, setTimeSignature, } = useTimeline();
    const onZoomIn = () => {
    ...
    return (React.createElement("div", { className: "flex items-center space-x-2 p-2 bg-slate-700 select-none border-t-[0.1rem] border-slate-400 shadow-xl" },
